...
# def annontate_every_even_number(numbers):
#     counter = 1
#     for number in numbers:
#         if (is_even(counter)):  #counter % 2 ==0
#             print(" " + str(number))
#         else:
#             print(number)
#         counter += 1
#
# annontate_every_even_number([4, 7, 4, 2, 8, 5])
...
print(concatenate_shorts(["alma", "körte", "cseresznye", "egy", "az", "xy", "az"]))